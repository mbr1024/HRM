...
<%@taglib uri="http://syl.pager-tags" prefix="syl" %>
                ...
                if (checkedBoxs.length < 1) {
                    ...
                    $.ligerDialog.confirm("确认要删除吗?", "删除用户", function (r) {
                        if (r) {
                            alert("删除：" + ids.get());
                            // 发送请求
                            window.location = "${pageContext.request.contextPath}/user/removeUser.do?ids=" + ids.get();
                        }
                    });
                }
            })
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
                ...
                <tr>
                    <td class="fftd">
                        <form name="empform" method="post" id="empform"
                              action="${pageContext.request.contextPath}/user/findUser.do">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                ...
                <c:forEach items="${users}" var="user">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);"
                        ...
                        <td align="center" width="40px;"><a
                                href="${pageContext.request.contextPath}/user/updateUser.do?id=${user.id}&flag=1">
    ...
    <tr valign="top">
        <td align="center" class="font3">
            <syl:pager pageIndex="${pageModel.pageIndex}"
                       pageSize="${pageModel.pageSize}"
                       recordCount="${pageModel.recordCount}"
                       submitUrl="${pageContext.request.contextPath}/user/findUser.do?pageIndex={0}&username=${user.username}&status=${user.status}"/>
    </tr>
    <%--<tr valign="top">--%>
    <%--<td align="center" class="font3">--%>
    <%--<fkjava:pager--%>
...
<%--<td><f:formatDate value="${user.createDate}" --%>
<%--type="date" dateStyle="long"/></td>--%>
<%--<td align="center" width="40px;"><a href="${pageContext.request.contextPath}/jsp/user/showUpdateUser.jsp">--%>
<%--<img title="修改" src="${pageContext.request.contextPath}/images/update.gif"/></a>--%>
<%--</td>--%>
<%--</tr>--%>