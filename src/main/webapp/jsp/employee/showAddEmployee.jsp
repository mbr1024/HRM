...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            <form action="${pageContext.request.contextPath}/employee/addEmployee.do" id="employeeForm" method="post">
                <!-- 隐藏表单，flag表示添加标记 -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                        ...
                        <td class="font3 fftd">
                            <table>
                                <tr>
                                    ...
                                    <td class="font3 fftd">身份证号码：<input type="text" name="card_Id" id="cardId"
                                                                        size="20"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="tel"
                                                                                                         id="tel"
                                                                                                         size="20"/>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="font3 fftd">
                            ...
                            QQ&nbsp;&nbsp;号码：<input name="QQ_Num" id="qqNum" size="20"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="main_tdbor"></td>
                    ...
                    <tr>
                        <td class="font3 fftd">
                            ...
                            邮政编码：<input name="post_Code" id="postCode" size="20"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="main_tdbor"></td>
