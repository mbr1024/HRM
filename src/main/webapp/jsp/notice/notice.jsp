        ...
        $(function () {
                ...
                if (checkedBoxs.length < 1) {
                    ...
                    $.ligerDialog.confirm("确认要删除吗?", "删除公告", function (r) {
                        if (r) {
                            // alert("删除："+ids.get());
                            // 发送请求
                            window.location = "${pageContext.request.contextPath}/notice/removeNotice.do?ids=" + ids.get();
                        }
                    });
                }
            })
            ...
            $("a[id^='prev_']").click(function () {
                ...
                $.ligerDialog.open({
                    title: '预览公告',
                    height: 500,
                    url: '${pageContext.request.contextPath}/notice/previewNotice.do?id=' + noticeId,
                    width: 750,
                    showMax: true,
                    showToggle: true,
                    showMin: true,
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td width="15" height="32"><img src="${pageContext.request.contextPath}/images/main_locleft.gif" width="15"
                                        height="32"></td>
        <td class="main_locbg font2"><img src="${pageContext.request.contextPath}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：公告管理
            &gt; 公告查询
        </td>
                ...
                <tr>
                    <td class="fftd">
                        <form name="noticeform" method="post" id="noticeform"
                              action="${pageContext.request.contextPath}/notice/findNotice.do">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                ...
                <c:forEach items="${requestScope.notices}" var="notice" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);"
                        ...
                        <td align="center" width="40px;"><a
                                href="${pageContext.request.contextPath}/notice/updateNotice.do?flag=1&id=${notice.id}">
    ...
    <tr valign="top">
        <td align="center" class="font3">
            <syl:pager
                    ...
                    style="digg"
                    submitUrl="${pageContext.request.contextPath}/notice/findNotice.do?pageIndex={0}&title=${notice.title}&content=${notice.content}"/>
        </td>
    </tr>
</table>
