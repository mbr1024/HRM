	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除部门",function(r){
	 				   if(r){
						   alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${pageContext.request.contextPath}/dept/removeDept.do?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="deptform" method="post" id="deptform" action="${pageContext.request.contextPath}/dept/findDept.do">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${requestScope.depts}" var="dept" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${dept.id}"></td>
					 <td>${dept.name }</td>
					  <td>${dept.remark }</td>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/dept/updateDept.do?flag=1&id=${dept.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <syl:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/dept/findDept.do?pageIndex={0}&name=${name  }"/>
	  </td></tr>
	</table>
