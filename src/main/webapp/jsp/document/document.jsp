...
<head>
    ...
    <link href="${pageContext.request.contextPath}/js/ligerUI/skins/Aqua/css/ligerui-dialog.css" rel="stylesheet"
          type="text/css"/>
    ...
    <script type="text/javascript">
        $(function () {
                ...
                if (checkedBoxs.length < 1) {
                    ...
                    $.ligerDialog.confirm("确认要删除吗?", "删除文档", function (r) {
                        if (r) {
                            // alert("删除："+ids.get());
                            // 发送请求
                            window.location = "${pageContext.request.contextPath}/document/removeDocument.do?ids=" + ids.get();
                        }
                    });
                }
            })
            ...
            $("a[id^='down_']").click(function () {
                ...
                /** 下载该文档 */
                window.location = "${pageContext.request.contextPath}/document/downLoad.do?id=" + id;
            })
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td width="15" height="32"><img src="${pageContext.request.contextPath}/images/main_locleft.gif" width="15"
                                        height="32"></td>
        <td class="main_locbg font2"><img src="${pageContext.request.contextPath}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：文档管理
            &gt; 文档查询
        </td>
                ...
                <tr>
                    <td class="fftd">
                        <form name="documentform" method="post" id="documentform"
                              action="${pageContext.request.contextPath}/document/findDocument.do">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                ...
                <c:forEach items="${requestScope.documents}" var="document" varStatus="stat">
                    <tr ondblclick="down(${document.id});" class="main_trbg" align="center" id="data_${stat.index}">
                        ...
                        <td align="center" width="40px;"><a
                                href="${pageContext.request.contextPath}/document/updateDocument.do?flag=1&id=${document.id}">
    ...
    <tr valign="top">
        <td align="center" class="font3">
            <syl:pager
                    ...
                    submitUrl="${pageContext.request.contextPath}/document/findDocument.do?pageIndex={0}&title=${title}"
                    style="flickr"
            />
        </td>
    </tr>
