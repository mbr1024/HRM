                ...
                if (checkedBoxs.length < 1) {
                    ...
                    $.ligerDialog.confirm("确认要删除吗?", "删除职位", function (r) {
                        if (r) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "${pageContext.request.contextPath}/job/removeJob.do",
                                data: {"ids": ids.get()},
                            ...
                            //传统方法实现删除
                            <%--window.location = "${pageContext.request.contextPath}/job/removeJob.do?ids=" + ids.get();--%>
                        }
                    });
                }
            })
                ...
                <tr>
                    <td class="fftd">
                        <form name="jobform" method="post" id="jobform"
                              action="${pageContext.request.contextPath}/job/findJob.do">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                                        职位名称：<input type="text" name="name" value="${name}">
                ...
                <c:forEach items="${requestScope.jobs}" var="job" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);"
                        ...
                        <td align="center" width="40px;"><a
                                href="${pageContext.request.contextPath}/job/findJobById.do?flag=1&id=${job.id}">
    ...
    <tr valign="top">
        <td align="center" class="font3">
            <syl:pager
                    ...
                    style="digg"
                    submitUrl="${pageContext.request.contextPath}/job/findJob.do?pageIndex={0}&name=${name}"/>
        </td>
    </tr>
</table>
