	 ...
	 $(function(){
			...
			$("#update").click(function(){
				...
				if (msg != ""){
					...
					$.post("${pageContext.request.contextPath}/job/updateJob.do",
							$("#jobForm").serialize(),
							function(data){
								if(data =="OK"){
									alert("信息修改成功！");
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/job/updateJob.do" id="jobForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" id="update" value="修改 ">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="javascript:window.history.back(-1)"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
